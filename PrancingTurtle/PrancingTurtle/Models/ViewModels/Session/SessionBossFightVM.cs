...
{
    public class SessionBossFightVM
    {
        ...
        public List<RankPlayerGuild> Top10BurstDamage1S
        {
            get
            {
                if (TopBurstDamage1S == null || !TopBurstDamage1S.Any())
                {
                    return new List<RankPlayerGuild>();
                }

                return TopBurstDamage1S.OrderByDescending(b => b.Value).Take(10).ToList();
            }
        }

        public List<RankPlayerGuild> Top10BurstDamage1SWarrior
        {
            get
            {
                if (TopBurstDamage1S == null || !TopBurstDamage1S.Any())
                ...
                return TopBurstDamage1S.Where(b => b.Class == "Warrior").OrderByDescending(b => b.Value).Take(10).ToList();
            }
        }
        public List<RankPlayerGuild> Top10BurstDamage1SMage
        {
            get
            {
                if (TopBurstDamage1S == null || !TopBurstDamage1S.Any())
                ...
                return TopBurstDamage1S.Where(b => b.Class == "Mage").OrderByDescending(b => b.Value).Take(10).ToList();
            }
        }
        public List<RankPlayerGuild> Top10BurstDamage1SCleric
        {
            get
            {
                if (TopBurstDamage1S == null || !TopBurstDamage1S.Any())
                ...
                return TopBurstDamage1S.Where(b => b.Class == "Cleric").OrderByDescending(b => b.Value).Take(10).ToList();
            }
        }
        public List<RankPlayerGuild> Top10BurstDamage1SRogue
        {
            get
            {
                if (TopBurstDamage1S == null || !TopBurstDamage1S.Any())
                ...
                return TopBurstDamage1S.Where(b => b.Class == "Rogue").OrderByDescending(b => b.Value).Take(10).ToList();
            }
        }
        public List<RankPlayerGuild> Top10BurstDamage1SPrimalist
        {
            get
            {
                if (TopBurstDamage1S == null || !TopBurstDamage1S.Any())
                ...
                return TopBurstDamage1S.Where(b => b.Class == "Primalist").OrderByDescending(b => b.Value).Take(10).ToList();
            }
        }
        ...
        public SessionBossFightVM()
        {
            // Default the timezone to UTC
            TimeZoneId = "UTC";
            FastestKills = new List<Database.Models.Encounter>();
        }
    }
}